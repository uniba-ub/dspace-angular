...
import { AssociateItemListComponent } from './associateitems-list.component';
...
describe('AssociateItemListComponent', () => {
  let component: AssociateItemListComponent;
  let fixture: ComponentFixture<AssociateItemListComponent>;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [ AssociateItemListComponent ],
      imports : [
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(AssociateItemListComponent);
