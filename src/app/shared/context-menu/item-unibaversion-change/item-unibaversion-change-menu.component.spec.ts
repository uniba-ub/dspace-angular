...
import { ItemVersionChangeMainUnibaMenuComponent } from './item-unibaversion-change-menu.component';
import { SharedModule } from '../../shared.module';

describe('ItemVersionChangeMainUnibaMenuComponent', () => {
  let component: ItemVersionChangeMainUnibaMenuComponent;
  let fixture: ComponentFixture<ItemVersionChangeMainUnibaMenuComponent>;
  let de: DebugElement;
  ...
  beforeEach(waitForAsync(() => {
    ...
    TestBed.configureTestingModule({
      declarations: [ItemVersionChangeMainUnibaMenuComponent],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(ItemVersionChangeMainUnibaMenuComponent);
