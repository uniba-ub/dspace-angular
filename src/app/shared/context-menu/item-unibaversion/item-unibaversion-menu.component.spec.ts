...
import { ItemVersionUnibaMenuComponent } from './item-unibaversion-menu.component';
import { SharedModule } from '../../shared.module';

describe('ItemVersionUnibaMenuComponent', () => {
  let component: ItemVersionUnibaMenuComponent;
  let fixture: ComponentFixture<ItemVersionUnibaMenuComponent>;
  let de: DebugElement;
  ...
  beforeEach(waitForAsync(() => {
    ...
    TestBed.configureTestingModule({
      declarations: [ItemVersionUnibaMenuComponent],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(ItemVersionUnibaMenuComponent);
